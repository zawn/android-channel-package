...
public class WorkingCopy {
    ...
    private static ISVNEventHandler mCommitEventHandler;
    private static ISVNEventHandler mUpdateEventHandler;
    private static ISVNEventHandler mWCEventHandler;
    ...
    public static void main(String[] args) throws SVNException {
        ...
        try {
            repositoryURL = SVNURL.parseURIEncoded("http://192.168.1.2:8090/svn/work/trunk/tmp");
        } catch (SVNException e) {
            //
        }
        String name = "ant";
        String password = "zhang1990";
         ...
         */
        mCommitEventHandler = new CommitEventHandler();

        mUpdateEventHandler = new UpdateEventHandler();

        mWCEventHandler = new WCEventHandler();
         ...
         * instance
         */
        ourClientManager.getCommitClient().setEventHandler(mCommitEventHandler);

        /*
         * Sets a custom event handler for operations of an SVNUpdateClient 
         * instance
         */
        ourClientManager.getUpdateClient().setEventHandler(mUpdateEventHandler);

        /*
         * Sets a custom event handler for operations of an SVNWCClient 
         * instance
         */
        ourClientManager.getWCClient().setEventHandler(mWCEventHandler);
        ...
        System.out.println(anImportDir);
